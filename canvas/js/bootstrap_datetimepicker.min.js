    ...
    g.prototype = {
        constructor: g, _events: [], _attachEvents: function () {
            ...
            if (this.formatViewType === "time") {
                ...
                this.setTitle(".datetimepicker-hours", t + " " + e[this.language].months[G] + " " + n);
                this.setTitle(".datetimepicker-minutes", t + " " + e[this.language].months[G] + " " + n)
            }
