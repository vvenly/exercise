(function(a) {
    ...
    g.prototype = {
        ...
        fill: function() {
            ...
            var E = new Date(this.viewDate)
                ...
                , D = new Date();
            this.setTitle(".datetimepicker-days",t + " " +  e[this.language].months[G]);
    ...
    var c = {
        ...
        headTemplate: '<thead><tr><th class="prev"><i class="{iconType} {leftArrow}"/></th><th colspan="5" class="switch">1</th><th class="next"><i class="{iconType} {rightArrow}"/></th></tr></thead>',
        headTemplateV3: '<thead><tr><th class="prev"><span class="{iconType} {leftArrow}"></span> </th><th colspan="5" class="switch">2</th><th class="next"><span class="{iconType} {rightArrow}"></span> </th></tr></thead>',
